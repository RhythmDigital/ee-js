package com.wehaverhythm.utils
{
	public class ArrayUtils
	{
		...
		public static function arrayGetRandom(numItems:int, arrayIn:Array):Array {
			var clone:Array = ArrayUtils.copyArray(arrayIn);
			var arrayOut:Array = [];
			
			while(numItems > 0) {
				var seed:int = Math.floor(Math.random()*clone.length);
